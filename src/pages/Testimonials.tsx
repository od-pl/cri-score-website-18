          ...
          <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-3xl font-bold text-gray-900 mb-2">25.8K</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Read in-depth case studies of student success
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="bg-white hover:shadow-lg transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  How PLAT helped one student overcome academic challenges and
                  land a coveted position at a leading tech firm.
                </p>
            ...
            <Card className="bg-white hover:shadow-lg transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  A case study on how PLAT is bridging the gap between
                  education and industry requirements, resulting in higher
                  placement rates.
                </p>
                <Button variant="outline">
                  Read More
